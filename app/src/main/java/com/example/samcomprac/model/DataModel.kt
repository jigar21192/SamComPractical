...
//    @SerializedName("ProductPictures"                ) var ProductPictures                : ArrayList<String> = arrayListOf(),
//    @SerializedName("ProductFullSizePictures"        ) var ProductFullSizePictures        : ArrayList<String> = arrayListOf(),
    @SerializedName("ProductCategories") var ProductCategories: String? = null,
//    @SerializedName("ProductAttributes"              ) var ProductAttributes              : ArrayList<String> = arrayListOf(),
//    @SerializedName("ProductSpecificationAttributes" ) var ProductSpecificationAttributes : ArrayList<String> = arrayListOf(),
